...
<body class="bg-gray-50 flex items-center justify-center min-h-screen p-4">
    ...
    <div class="max-w-md w-full bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
        ...
        <div class="bg-[#1a365d] p-6 text-center relative overflow-hidden">
            ...
            <h1 class="relative z-10 text-2xl font-extrabold text-white">Dokumen Valid</h1>
        ...
        <div class="p-6">
            ...
            <div class="space-y-4">
                <div class="border-b border-gray-100 pb-3">
                    ...
                    <p class="font-semibold text-gray-800">Bukti Penyelenggaraan Pelatihan</p>
                </div>
                <div class="border-b border-gray-100 pb-3">
                    <p class="text-xs text-gray-500">Nama Pelatihan</p>
                    <p class="font-semibold text-gray-800">{{ $event->pelatihan->nama_pelatihan ?? $event->nama_event }}</p>
                </div>
                <div class="border-b border-gray-100 pb-3">
                ...
                <div>
                    ...
                    <p class="font-bold text-[#1a365d] text-lg">dr. WINDY ARY WIJAYA, Sp.An-Ti.</p>
        ...
        <div class="bg-gray-50 p-4 text-center border-t border-gray-100">
            <p class="text-[11px] text-gray-500">Scan QR Code membuktikan bahwa dokumen cetak yang Anda pegang adalah asli dan sah dikeluarkan oleh sistem Flash Inspire Training Center.</p>
        </div>
    </div>
