                ...
                <tr class="hover:bg-blue-50/50 border-b border-gray-50 transition-colors">
                    ...
                    <td class="p-5 text-center">
                        <div class="flex flex-col gap-1.5 items-center">
                           <a href="{{ route('event.absensi', $item->id) }}" class="flex items-center justify-center gap-1.5 bg-teal-50 text-teal-600 hover:bg-teal-500 hover:text-white px-3 py-1.5 rounded-lg border border-teal-200 text-xs font-bold transition-all w-28">
    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>
    </svg> 
    Absensi
</a>
   <a href="{{ route('event.evaluasi', $item->id) }}" class="flex items-center justify-center gap-1.5 bg-violet-50 text-violet-600 hover:bg-violet-500 hover:text-white px-3 py-1.5 rounded-lg border border-violet-200 text-xs font-bold transition-all w-28">
    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path></svg> Evaluasi
</a>                       <a href="{{ route('event.pembayaran', $item->id) }}" class="flex items-center justify-center gap-1.5 bg-orange-50 text-orange-600 hover:bg-orange-500 hover:text-white px-3 py-1.5 rounded-lg border border-orange-200 text-xs font-bold transition-all w-28">
    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> Pembayaran
</a>
                            <a href="{{ route('event.penilaian-skill', $item->id) }}" class="flex items-center justify-center gap-1.5 bg-purple-50 text-purple-600 hover:bg-purple-500 hover:text-white px-3 py-1.5 rounded-lg border border-purple-200 text-xs font-bold transition-all w-28">
