                ...
                <tr class="hover:bg-blue-50/50 border-b border-gray-50 transition-colors">
                    ...
                    <td class="p-5 text-center">
                        <div class="flex flex-col gap-1.5 items-center">
                            ...
                            <button onclick="Swal.fire('Segera Hadir', 'Halaman Rekap Pembayaran sedang dikerjakan', 'info')" class="flex items-center justify-center gap-1.5 bg-orange-50 text-orange-600 hover:bg-orange-500 hover:text-white px-3 py-1.5 rounded-lg border border-orange-200 text-xs font-bold transition-all w-28">
